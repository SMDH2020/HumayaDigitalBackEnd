                    ...
                    document.Page(page =>
                    {
                        ...
                        page.Content().PaddingTop(14).PaddingLeft(25).PaddingRight(25).Column(col =>
                        {
                            ...
                            col.Item().Border(0.5f).BorderColor(verde).Column(sec =>
                            {
                                ...
                                // Fila 2 — porcentajes y confiabilidad (4 KPIs con barra)
                                sec.Item().Table(t =>
                                {
                                    t.ColumnsDefinition(c =>
                                    {
                                    ...
                                    KpiPorcentaje(t, "% FALTANTE", info.porc_faltante, "#c0392b", "#fff0f0", grisLinea, font, menorEsMejor: true);
                                    KpiPorcentaje(t, "% SOBRANTE", info.porc_sobrante, "#1a6fa8", "#f0f5ff", grisLinea, font, menorEsMejor: true);
                            ...
                            col.Item().Border(0.5f).BorderColor(verde).Column(sec =>
                            {
                                ...
                                sec.Item().Table(t =>
                                {
                                    t.ColumnsDefinition(c =>
                                    {
                                        ...
                                        c.RelativeColumn(1.8f);  // comentario
                                    });
                                    ...
                                    t.Header(h =>
                                    {
                                        ...
                                        TH("TIPO"); TH("IMPORTE DIF."); TH("COMENTARIO");
                                    });
