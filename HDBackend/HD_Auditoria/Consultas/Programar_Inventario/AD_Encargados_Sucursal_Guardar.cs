...
{
    public class AD_Encargados_Sucursal_Guardar
    {
        private string CadenaConexion;
        public AD_Encargados_Sucursal_Guardar(string _cadenaconexion)
        {
            CadenaConexion = _cadenaconexion;
        }

        public async Task<mdl_Result_SP> GuardarEncargados(mdl_Encargados mdl)
        {
            try
            {
                ...
                parametros.Add("@encargados", mdl.encargados, System.Data.DbType.String, System.Data.ParameterDirection.Input);
                ...
                await factory.SQL.ExecuteAsync("Auditoria.SP_Encargados_Sucursal_Guardar", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
