...
{
    public class AD_Programar_Inventario_Extender_Fecha
    {
        private string CadenaConexion;
        public AD_Programar_Inventario_Extender_Fecha(string _cadenaconexion)
        {
        ...
        public async Task<mdl_Result_SP> ExtenderFecha(mdl_ExtenderFecha mdl)
        {
            try
            {
                ...
                await factory.SQL.ExecuteAsync("Auditoria.SP_PROG_AUDITORIA_EXTENDER_FECHA", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
