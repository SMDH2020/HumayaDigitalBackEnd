...
{
    public class AD_ReporteAjuste_PDF
    {
        private string CadenaConexion;
        public AD_ReporteAjuste_PDF(string _cadenaconexion)
        {
        ...
        public async Task<mdl_ReporteSimplificado_View> Listado(string? folio)
        {
            try
            {
                ...
                var result = await factory.SQL.QueryMultipleAsync("Auditoria.sp_GENERA_REPORTE_AUDITORIA_AJUSTE", parametros, commandType: System.Data.CommandType.StoredProcedure);
