...
{
    public class AD_JustificarAuditoria_Modificar
    {
        private string CadenaConexion;
        public AD_JustificarAuditoria_Modificar(string _cadenaconexion)
        {
            CadenaConexion = _cadenaconexion;
        }

        public async Task<mdl_Notificar_View> JustificacionRechazar(mdl_Justificaciones_Acciones mdl)
        {
            try
            {
                ...
                parametros.Add("@rechazado", dbType: System.Data.DbType.Int32, direction: System.Data.ParameterDirection.Output);


                FactoryConection factory = new FactoryConection(CadenaConexion);
                var result = await factory.SQL.QueryMultipleAsync("Auditoria.SP_JUST_AUDITORIA_RECHAZAR", parametros, commandType: System.Data.CommandType.StoredProcedure);
                mdl_Notificar_View listado = new mdl_Notificar_View();
                //Resultset del SELECT
                ...
                listado.estatus = new mdl_Result_SP
                {
                    ...
                    rechazado = parametros.Get<int>("@rechazado")
                };
                factory.SQL.Close();
                return listado;
            }
