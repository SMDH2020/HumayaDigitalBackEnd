...
namespace HD_Cobranza.Reportes
{
    public class XLSCob_Dashboard_ReporteProyeccionTotal
    {
        ...
        public static Task<DocResult> GenerarExcel(IEnumerable<mdl_Reporte_Proyeccion_Recuperacion_Mensual_tipo_cartera> detalle, int ejercicio, int periodo, string mes, string sucursales, string adr)
        {
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    int renglon = XLSEncabezado.Encabezado(ref sheet, "PROYECCION DE RECUPERACION TOTAL " + FormatearMesAnio(mes), 17);
