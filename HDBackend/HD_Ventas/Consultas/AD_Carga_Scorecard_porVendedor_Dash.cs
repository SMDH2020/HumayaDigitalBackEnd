    ...
    public class AD_Carga_Scorecard_porVendedor_Dash
    {
        ...
        public async Task<IEnumerable<mdlCarga_Scorecard_porVendedor_Dash>> Scorecard(int usuario)
        {
            try
            {
                ...
                var tiposFaltantes = new List<string> { "TRACTORES", "IMPLEMENTOS", "JARDINEROS", "AUTOGUIADO", "DRONES", "PRODUCTO ALIADO", "TRACTORES SEMINUEVOS", "TRILLADORAS SEMINUEVAS", "GARANTIA EXTENDIDA", "POLIZA MANTENIMIENTO", "VISITAS", "REFACCIONES" };
