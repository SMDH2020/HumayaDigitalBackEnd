...
{
    public class XLSVen_Detalle_Facturacion_Scorecard_Mensual
    {
        ...
        public static Task<DocResult> GenerarExcel(IEnumerable<mdlDetalle_Facturacion_Scorecard> detalle, int ejercicio, int periodo)
        {
            try
            {
                ...
                using (var workbook = new XLWorkbook())
                {
                    ...
                    int renglon = XLSEncabezado.Encabezado(ref sheet, $"FACTURACION DE MAQUINARIA MENSUAL {obtenernombre_mes(periodo) + " " + ejercicio}", 8);
