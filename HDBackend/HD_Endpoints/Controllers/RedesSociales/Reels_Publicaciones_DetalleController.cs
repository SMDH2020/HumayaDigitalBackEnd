...
namespace HD.Endpoints.Controllers.RedesSociales
{
    ...
    public class Reels_Publicaciones_DetalleController : MyBase
    {
        private readonly IConfiguration _configuracion;
        private readonly ISesion _session;

        public Reels_Publicaciones_DetalleController(IConfiguration configuracion, ISesion session)
        {
        ...
        [HttpPost("Guardar")]
        public async Task<IActionResult> Guardar([FromBody] mdl_Reels_Publicaciones_Detalle detalle)
        {
            try
            {
                ...
                AD_Reels_Publicaciones_Detalle ad = new AD_Reels_Publicaciones_Detalle(cadenaConexion);
        ...
        [HttpPost("Editar")]
        public async Task<IActionResult> Editar([FromBody] mdl_Reels_Publicaciones_Detalle detalle)
        {
            try
            {
        ...
        [HttpPost("Eliminar")]
        public async Task<IActionResult> Eliminar([FromBody] mdl_Reels_Publicaciones_Detalle detalle)
        {
            try
            {
                if (detalle == null || string.IsNullOrEmpty(detalle.Folio))
