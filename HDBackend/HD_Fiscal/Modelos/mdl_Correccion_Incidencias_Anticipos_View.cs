namespace HD.Fiscal.Modelos
{
    public class mdl_Correccion_Incidencias_Anticipos_View
    {
        ...
        public IEnumerable<mdl_Correccion_Incidencias_Anticipos_Notas_SinRelacion> Notas_SinRelacion { get; set; }
        public IEnumerable<mdl_Incidencias_Anticipos_SinUUID> anticipos_SinUUID { get; set; }
        public IEnumerable<mdl_Incidencias_Anticipos_rel_Multiples_Notas> Anticipos_Multiples_Notas { get; set; }
