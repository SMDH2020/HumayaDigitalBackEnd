...
namespace HD_Reporteria.Cobranza
{
    public class RPT_Dashboard_ReporteTotal
    {
        ...
        public static RPT_Result GenerarPDF(IEnumerable<mdl_Dashboard_Reporte_Grafica_Total> detalle, int ejercicio, int periodo, string tipo_cartera)
        {
            try
            {
                    ...
                    document.Page(page =>
                    {
                        ...
                        page.Header().Height(120).Row(row =>
                        {
                            ...
                            row.ConstantColumn(0).Row(row1 =>
                            {
                                ...
                                {
                                    row2.RelativeItem().Padding(5).PaddingTop(10).PaddingLeft(20).Text("REPORTE TOTAL DE CARTERA " + obtenerCartera(tipo_cartera) + " " + obtenernombre_mes(periodo) + " " + ejercicio).FontColor("#fff").FontSize(15).Bold().FontFamily(fontFamily);
                            ...
                            col1.Item().PaddingVertical(10).Border(1).BorderColor("#477c2c").Table(tabla =>
                            {
                                ...
                                foreach (var det in detalle)
                                {
                                   ...
                                   .Text(det.razon_social?.ToUpper()).FontSize(9).FontFamily(fontFamily);
                                    ...
                                    .Text(det.vencimiento).FontSize(9).FontFamily(fontFamily);
