...
{
    public class RPT_Dashboard_ReporteProyeccionMensual
    {
        ...
        public static RPT_Result GenerarPDF(IEnumerable<mdl_Dashboard_Recuperacion_Mensual_Detalle> detalle, int ejercicio, int periodo, string mes, string sucursales, string adr, string tipo_cartera)
        {
            try
            {
                    ...
                    document.Page(page =>
                    {
                        ...
                        page.Header().Height(120).Row(row =>
                        {
                            ...
                            row.ConstantColumn(0).Row(row1 =>
                            {
                                ...
                                {
                                    row2.RelativeItem().Padding(5).PaddingTop(10).PaddingLeft(20).Text("PROYECCION DE REC. DE CARTERA " + obtenerCartera(tipo_cartera) + " " + FormatearMesAnio(mes)).FontColor("#fff").FontSize(14).Bold().FontFamily(fontFamily);
                ...
                result.nombredocumento = "REPORTE PROYECCION";
