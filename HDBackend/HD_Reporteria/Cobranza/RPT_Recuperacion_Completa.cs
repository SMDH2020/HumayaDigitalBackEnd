                ...
                page.Content().PaddingTop(10).PaddingLeft(30).PaddingRight(30).Column(col1 =>
                {
                    ...
                    col1.Item().PaddingVertical(10).Border(1).BorderColor("#477c2c").Table(tabla =>
                    {
                        ...
                        foreach (var total in datos.total)
                        {
                           ...
                           .Text(Math.Truncate(total.cartera_activa / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.cartera_porvencer / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.cartera_vencida / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.total_cartera / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderLeft(0.6f).BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.objetivo_porvencer / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.objetivo_vencido / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderRight(0.6f).BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.objetivo / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderLeft(0.6f).BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.recuperacion_mes / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.recuperacion_activa / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.recuperacion_porvencer / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);
                           ...
                           .Text(total.porcporvencer.ToString("N2")).FontSize(8).FontFamily(fontFamily);
                            ...
                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.recuperacion_vencida / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);
                           ...
                           .Text(total.porcvencido.ToString("N2")).FontSize(8).FontFamily(fontFamily);
                            ...
                            tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.total_recuperado / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);

                            tabla.Cell().BorderLeft(0.6f).BorderBottom(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle().PaddingRight(3)
                           .Text(Math.Truncate(total.recuperado / 1000).ToString("N0")).FontSize(8).FontFamily(fontFamily);
