...
{
    public class RPT_Listado_Clientes_Gestionar_Prueba_2
    {
            ...
            public static RPT_Result GenerarPDF(IEnumerable<mdl_Listado_Clientes_Gestionar_Prueba_2> detalle)
            {
                try
                {
                                ...
                                col1.Item().PaddingVertical(10).Border(1).BorderColor("#477c2c").Table(tabla =>
                                {
                                    ...
                                    tabla.Header(header =>
                                    {
                                       ...
                                       .Padding(1).Text("SALDO").FontSize(8).Bold().FontFamily(fontFamily).FontColor("#fff");
                                        ...
                                        header.Cell().BorderBottom(1).BorderColor("#fedb05").Background("#477c2c").AlignCenter().AlignMiddle()
                                        .Padding(1).Text("FECHA CONT.").FontSize(8).Bold().FontFamily(fontFamily).FontColor("#fff");
                                        header.Cell().BorderBottom(1).BorderColor("#fedb05").Background("#477c2c").AlignCenter().AlignMiddle()
                                    ...
                                    foreach (var det in detalle)
                                    {
                                       ...
                                       .Text(det.capital.ToString("N2")).FontSize(8).FontFamily(fontFamily);
                                        ...
                                        tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().AlignMiddle().PaddingRight(3).PaddingVertical(3).ShowEntire()
                                       .Text(det.interes_normal.ToString("N2")).FontSize(8).FontFamily(fontFamily);

                                        tabla.Cell().BorderBottom(1).BorderColor("#afb69d").AlignRight().AlignMiddle().PaddingRight(3).PaddingVertical(3).ShowEntire()
                                       .Text(det.interes_moratorio.ToString("N2")).FontSize(8).FontFamily(fontFamily);
