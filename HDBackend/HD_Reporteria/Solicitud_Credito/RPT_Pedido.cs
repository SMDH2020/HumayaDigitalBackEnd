                ...
                byte[] doc = Document.Create(document =>
                {
                    document.Page(page =>
                    {
                        ...
                        col1.Item().PaddingTop(10).Row(row1 =>
                            ...
                            col1.Item().Border(1).BorderColor("#afb69d").Padding(05).Text(mdl.condiciones?.condiciones).FontSize(8).FontFamily(fontFamily).Justify();

                            col1.Item().PaddingTop(05).Text("Observaciones").FontSize(10).FontFamily(fontFamily);
                            col1.Item().Border(1).BorderColor("#afb69d").Padding(05).Text(mdl.condiciones?.observaciones).FontSize(8).FontFamily(fontFamily).Justify();
                            ...
                            col1.Item().Extend().ShowEntire().AlignBottom().Column(innerCol =>
                            {
                                ...
                                // Firmas
                                innerCol.Item().PaddingTop(10).Row(row1 =>
                                {
                        ...
                        page.Footer().Height(110).PaddingLeft(30).PaddingRight(30).Column(col1 =>
                        {
                            col1.Item().AlignRight().PaddingTop(60).Text(txt =>
                            {
