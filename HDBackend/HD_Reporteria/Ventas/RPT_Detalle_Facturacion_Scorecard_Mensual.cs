...
{
    public class RPT_Detalle_Facturacion_Scorecard_Mensual
    {
        ...
        public static RPT_Result GenerarPDF(IEnumerable<mdlDetalle_Facturacion_Scorecard> detalle, int ejercicio, int periodo)
        {
            try
            {
                    ...
                    document.Page(page =>
                    {
                        ...
                        page.Header().Height(120).Row(row =>
                        {
                            ...
                            row.ConstantColumn(0).Row(row1 =>
                            {
                                ...
                                {
                                    row2.RelativeItem().Padding(10).PaddingLeft(30).Text("FACTURACION DE MAQUINARIA MENSUAL").FontColor("#fff").FontSize(20).Bold().FontFamily(fontFamily);
