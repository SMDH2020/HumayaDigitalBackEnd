                        ...
                        else
                        {
                            ...
                            col1.Item().PaddingVertical(10).Border(1).BorderColor("#275027").Table(tabla =>
                            {
                                    ...
                                    if (tipoActual != mdl.tipo)
                                    {
                                        if (tipoActual != "")
                                        {
                                            ...
                                            tabla.Cell().BorderTop(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle()
                                                .Text(totalProyeccion != 0 ? (totalDif * 100 / totalProyeccion).ToString("N2") : "0.00").FontSize(8).FontColor("#ff2037").FontFamily(fontFamily).Bold();
                                            ...
                                            tabla.Cell().BorderTop(1).BorderColor("#afb69d").AlignRight().Height(20).AlignMiddle()
                                                .Text(totalOldTotal != 0 ? (totalOldDif * 100 / totalOldTotal).ToString("N2") : "0.00").FontSize(8).FontFamily(fontFamily).Bold();
                                ...
                                tabla.Cell().BorderTop(1).BorderColor("#afb69d").Background("#cccccc").AlignRight().Height(20).AlignMiddle()
                                    .Text(totalProyeccionGeneral != 0 ? (totalDifGeneral*100/totalProyeccionGeneral).ToString("N2"): "0").FontSize(8).FontColor("#ff2037").FontFamily(fontFamily);
                                ...
                                tabla.Cell().BorderTop(1).BorderColor("#afb69d").Background("#cccccc").AlignRight().Height(20).AlignMiddle()
                                    .Text(totalOldTotalGeneral != 0 ? (totalOldDifGeneral*100/totalOldTotalGeneral).ToString("N2"):"0.00").FontSize(8).FontFamily(fontFamily);
