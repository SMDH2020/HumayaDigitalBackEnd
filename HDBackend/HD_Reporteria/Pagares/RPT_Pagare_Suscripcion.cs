                ...
                byte[] doc = Document.Create(document =>
                {
                    document.Page(page =>
                    {
                            ...
                            page.Content().PaddingTop(3).PaddingLeft(30).PaddingRight(30).Column(col1 =>
                            {
                                ...
                                {
                                    string moneda = mdl.tasa.moneda == "MXN" ? " pesos " + ((double)((detalle.importefinanciar - (double)detalle.importefinanciar) * 100)).ToString("00") + "/100 M.N. " : " dolares " + ((double)((detalle.importefinanciar - (double)detalle.importefinanciar) * 100)).ToString("00") + "/100 USD ";
