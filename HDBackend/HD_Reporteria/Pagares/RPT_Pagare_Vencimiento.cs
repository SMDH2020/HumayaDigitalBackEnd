                    ...
                    document.Page(page =>
                    {
                        ...
                        page.Content().PaddingTop(3).PaddingLeft(30).PaddingRight(30).Column(col1 =>
                        {
                            ...
                            col1.Item().PaddingTop(20).PaddingBottom(20).Text(txt =>
                            {
                                ...
                                txt.Span("         $ " + detalle.importefinanciar.ToString("N2") + " (" + ConvertirNumeroALetras(detalle.importefinanciar) + " pesos " + ((double)((detalle.importefinanciar - (double)detalle.importefinanciar) * 100)).ToString("00") + "/100 M.N.) ").FontSize(10).Bold().FontFamily("arial");
                            ...
                            col1.Item().PaddingTop(10).Text("El importe que ampara este pagaré causará intereses moratorios en forma mensual a partir de la fecha de vencimiento, calculados a razón de la tasa fija del " + (detalle.tasa > 0 ? detalle.tasa * 2 : mdl.tasa.tasa * 2) + "% por ciento anual sobre saldos insolutos.").FontSize(10).FontFamily("arial");
