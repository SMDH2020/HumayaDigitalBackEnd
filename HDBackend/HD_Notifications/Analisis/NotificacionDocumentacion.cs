...
{
    public class NotificacionDocumentacion
    {
        ...
        static string body(mdlSC_Analisis_Credito datos_Correo)
        {
            ...
            sHtml = "<HTML>\n" +
                ...
                "<div style=\"font-size:18px;\">" + "DOCUMENTO" + "</div>\n" +
                "</th>\n" +
                "<th class=\"celda-cliente-titulo\">\n" +
                "<div style=\"font-size:18px;\">" + "ESTATUS" + "</div>\n" +
                "</th>\n" +
                "<th class=\"celda-cliente-titulo\">\n" +
                "<div style=\"font-size:18px;\">" + "COMENTARIO" + "</div>\n" +
                "</th>\n" +
                "</tr>\n" +
                "</thead>\n" +
                "<tbody>\n";
