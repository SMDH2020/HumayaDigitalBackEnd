...
{
    public class AD_Reestructurar_Credito_Listado_Solicitudes
    {
        private string CadenaConexion;
        public AD_Reestructurar_Credito_Listado_Solicitudes(string _cadenaconexion)
        {
            CadenaConexion = _cadenaconexion;
        }
        public async Task<mdlSCAnalisis_View> Listado(int usuario, int idcliente)
        {
            try
            {
                ...
                IEnumerable<mdlSCAnalisis_Tablero> tablero = await factory.SQL.QueryAsync<mdlSCAnalisis_Tablero>("Credito.sp_Solicitud_Credito_Tablas_Por_Cliente", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
