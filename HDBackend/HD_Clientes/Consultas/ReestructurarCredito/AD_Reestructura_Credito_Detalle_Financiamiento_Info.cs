...
{
    public class AD_Reestructura_Credito_Detalle_Financiamiento_Info
    {
        private string CadenaConexion;
        public AD_Reestructura_Credito_Detalle_Financiamiento_Info(string _cadenaconexion)
        {
        ...
        public async Task<mdlPedido_Detalle_Financiamiento_View> Get(string folio)
        {
            try
            {
                ...
                var result = await factory.SQL.QueryMultipleAsync("Credito.sp_Reestructura_Credito_Detalle_Financiamiento_info", parametros, commandType: System.Data.CommandType.StoredProcedure);
