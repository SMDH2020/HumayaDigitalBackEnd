    ...
    public class ADSolicitud_Impresion_View
    {
        ...
        public async Task<mdl_Solicitud_Impresion> Get(string folio)
        {
            try
            {
                ...
                impresion.balancepatrimonial = result.Read<mdl_Solicitud_Balance_Patrimonial_View>().ToList();
                impresion.estadoresultados = result.Read<mdl_Solicitud_Estado_Resultados_View>().ToList();
