...
namespace HD.Clientes.Consultas.SolicitudCreditoDocumento
{
    public class ADSolicitudCredito_Documentacion_ObtenerDocumento
    {
        ...
        public async Task<RPT_Result> ObtenerPedidoOriginal(string folio, int iddocumento)
        {
            try
            {
                FactoryConection factory = new FactoryConection(CadenaConexion);
                ...
                RPT_Result result = await factory.SQL.QueryFirstOrDefaultAsync<RPT_Result>("Credito.sp_Solicitud_Credito_Documentacion_Pedido_Original_Obtener", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
                return result;
            }
            catch (System.Exception ex)
        ...
        public async Task<RPT_Result> ObtenerPedidoFacturado(string folio, int iddocumento)
        {
            try
            {
                FactoryConection factory = new FactoryConection(CadenaConexion);
                ...
                RPT_Result result = await factory.SQL.QueryFirstOrDefaultAsync<RPT_Result>("Credito.sp_Solicitud_Credito_Documentacion_Obtener_Resultado_Operacion", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
                return result;
            }
            catch (System.Exception ex)
