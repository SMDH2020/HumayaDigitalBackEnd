...
{
    public class AD_SCAnalisis_Tablero_Completo
    {
        private string CadenaConexion;
        public AD_SCAnalisis_Tablero_Completo(string _cadenaconexion)
        {
        ...
        public async Task<mdlSCAnalisis_View> Get(string usuario)
        {
            try
            {
                ...
                IEnumerable<mdlSCAnalisis_Tablero> tablero = await factory.SQL.QueryAsync<mdlSCAnalisis_Tablero>("Credito.sp_Solicitud_Credito_Tablas_Completo", parametros, commandType: System.Data.CommandType.StoredProcedure);
                factory.SQL.Close();
