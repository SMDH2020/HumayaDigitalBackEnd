...
namespace HD.Clientes.Consultas.AnalisisCredito
{
    public class ADAnalisiCreditoMhusa
    {
        ...
        public async Task<mdlAnalisis_Mhusa> GuardarAnalisis(mdl_Analisis_Documentacion comentario)
        {
            try
            {
                FactoryConection factory = new FactoryConection(CadenaConexion);
                var parametros = new
                {
                    ...
                    estatus = comentario.estatus,
                    usuario = comentario.usuario,
                    vencimiento = comentario.vencimiento,
                };
                var result = await factory.SQL.QueryMultipleAsync("Credito.SP_Solicitud_Credito_Analisis_Documentacion_Mhusa_Guardar", parametros, commandType: System.Data.CommandType.StoredProcedure);
                mdlAnalisis_Mhusa mhusa = new mdlAnalisis_Mhusa();
                mhusa.mdldatos = result.Read<mdldatos_notificacion>().FirstOrDefault();
                mhusa.estado = result.Read<mdlSCAnalisis_Pedido_Estado>().FirstOrDefault();
                mhusa.documentacion = result.Read<mdlSCAnalisis_Documentacion>().ToList();
        ...
        public async Task<mdlAnalisis_Mhusa> GuardarAnalisisCondicionado(mdl_Analisis_Documentacion comentario)
        {
            try
            {
                FactoryConection factory = new FactoryConection(CadenaConexion);
                ...
                var result = await factory.SQL.QueryMultipleAsync("Credito.SP_Solicitud_Credito_Analisis_Documentacion_Condicionada_Guardar", parametros, commandType: System.Data.CommandType.StoredProcedure);
                mdlAnalisis_Mhusa mhusa = new mdlAnalisis_Mhusa();
                mhusa.mdldatos = result.Read<mdldatos_notificacion>().FirstOrDefault();
                mhusa.estado = result.Read<mdlSCAnalisis_Pedido_Estado>().FirstOrDefault();
                mhusa.documentacion = result.Read<mdlSCAnalisis_Documentacion>().ToList();
        ...
        public async Task<mdlAnalisis_Mhusa> GuardarOtorgamientoVencimiento(mdl_Analisis_Documentacion comentario)
        {
            try
            {
                FactoryConection factory = new FactoryConection(CadenaConexion);
                ...
                var result = await factory.SQL.QueryMultipleAsync("Credito.SP_Solicitud_Credito_Task_Comentarios_Otorgamiento_Vencimiento_Mhusa_Guardar", parametros, commandType: System.Data.CommandType.StoredProcedure);
                mdlAnalisis_Mhusa mhusa = new mdlAnalisis_Mhusa();
                mhusa.mdldatos = result.Read<mdldatos_notificacion>().FirstOrDefault();
                mhusa.estado = result.Read<mdlSCAnalisis_Pedido_Estado>().FirstOrDefault();
                mhusa.documentacion = result.Read<mdlSCAnalisis_Documentacion>().ToList();
