...
{
    public class ADSolicitud_Credito_Enganche_Guardar
    {
        private string CadenaConexion;
        public ADSolicitud_Credito_Enganche_Guardar(string _cadenaconexion)
        {
            CadenaConexion = _cadenaconexion;
        }
        public async Task<mdlAnalisis_Mhusa> Guardar(mdlEnchanche_Mhusa comentario)
        {
            try
            {
                ...
                var result = await factory.SQL.QueryMultipleAsync("Credito.SP_Solicitud_Credito_Enganche_Guardar", parametros, commandType: System.Data.CommandType.StoredProcedure);
